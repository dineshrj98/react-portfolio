...
This project started as a project for the unit[IFN666 - Mobile and Web Application Developement](https://www.qut.edu.au/study/unit?unitCode=IFN666) but since it is a project I build for personal use I continue to develop it.
<br />
